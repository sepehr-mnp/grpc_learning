...
type ExtServiceClient interface {
	TopUser(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*User, error)
}
...
func (c *extServiceClient) TopUser(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*User, error) {
	out := new(User)
...
type ExtServiceServer interface {
	TopUser(context.Context, *empty.Empty) (*User, error)
...
func (UnimplementedExtServiceServer) TopUser(context.Context, *empty.Empty) (*User, error) {
...
func _ExtService_TopUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ExtServiceServer).TopUser(ctx, req.(*empty.Empty))
	}
